...
public class qrSelectorMeasure extends AbstractActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.qr_measure);

        btn_back = findViewById(R.id.back_button_qr_measure);
        btn_home = findViewById(R.id.home_button_qr_measure);
        btn_share = findViewById(R.id.btn_qr_measure_share);
